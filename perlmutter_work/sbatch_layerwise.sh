...
if __name__=='__main__':
    main(
        ...
        batch_size={0:256, 150:512},
        num_workers=8,
        gradient_clip_val=1,
        gradient_clip_algorithm='value',
        use_wandb=True,
        early_stopping_patience=250,
        transfer_model='experiment_256_v6/r41473243_1_2025_08_07_09_11_37/checkpoints/last.ckpt',
        fir_bp=(8,None),
        transfer_max_layer=99,
        transfer_layer_lr_factor=1.,
    )
END
)
